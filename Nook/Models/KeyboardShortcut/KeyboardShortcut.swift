...
enum ShortcutAction: String, CaseIterable, Hashable, Codable {
    ...
    case readerMode = "reader_mode"                            // Cmd+Shift+R... wait, taken. Use Cmd+Option+R
...
extension KeyboardShortcut {
    static var defaultShortcuts: [KeyboardShortcut] {
        [
            ...
            KeyboardShortcut(action: .readerMode, keyCombination: KeyCombination(key: "r", modifiers: [.command, .option]))
        ]
    }
}