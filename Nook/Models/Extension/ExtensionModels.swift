...
final class ExtensionEntity {
    ...
    var isEnabled: Bool
    /// Whether this extension should be shown as a toolbar button next to the URL bar.
    var isPinnedToToolbar: Bool = true
    ...
    init(
        ...
        self.isPinnedToToolbar = isPinnedToToolbar
...
struct InstalledExtension {
    ...
    init(from entity: ExtensionEntity, manifest: [String: Any]) {
        ...
        self.isPinnedToToolbar = entity.isPinnedToToolbar
    }
}
