...
private struct SettingsContent: View {
    ...
    var body: some View {
        TabView(selection: $nookSettings.currentSettingsTab) {
            ...
            .tabItem {
                Label(
                    SettingsTabs.autofill.name,
                    systemImage: SettingsTabs.autofill.icon
                )
            }
            .tag(SettingsTabs.autofill)
            ...
            SettingsPane {
                UserScriptsSettingsView()
            }
            .tabItem {
                Label(
                    SettingsTabs.userscripts.name,
                    systemImage: SettingsTabs.userscripts.icon
                )
            }
            .tag(SettingsTabs.userscripts)
...
// MARK: - Horizontal Tab Bar (no longer used)
// Legacy custom tab strip — kept only as dead code reference.
